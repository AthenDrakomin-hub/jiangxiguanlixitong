...
const redis = new Redis({
  ...
  token: process.env.KV_REST_API_TOKEN || process.env.UPSTASH_REDIS_TOKEN,
});

// Validate required environment variables
if (!(process.env.KV_REST_API_URL || process.env.UPSTASH_REDIS_URL) || 
    !(process.env.KV_REST_API_TOKEN || process.env.UPSTASH_REDIS_TOKEN)) {
  console.error('❌ Missing required Upstash Redis environment variables!');
  console.error('Please set: KV_REST_API_URL and KV_REST_API_TOKEN (or UPSTASH_REDIS_URL and UPSTASH_REDIS_TOKEN)');
