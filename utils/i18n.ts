...
const translations: Record<string, TranslationDictionary> = {
  'zh-CN': {
    ...
    revenue: '收入',
    'VIP包间': 'VIP Rooms',
    '为客房下单，订单将自动流转至后厨': 'Place orders for rooms, orders will automatically flow to kitchen',
    '房间号范围: 8201-8232 (2楼) 和 8301-8332 (3楼)': 'Room range: 8201-8232 (2F) and 8301-8332 (3F)',
    'Kuwarto': 'Room',
    'Occupied': 'Abala',
    'Vacant': 'Bakante',
    '提交中...': 'Submitting...',
    'Send to Kitchen': 'Ipadala sa Kusina',
    '正在提交订单...': 'Submitting order...',
    '客房点餐': 'Room Service Order',
    '房号': 'Room Number',
    '订单已发送至厨房！': 'Order sent to kitchen!',
    '订单提交失败，请重试。': 'Order submission failed, please try again.',
    'Order submission failed, please try again.': 'Nabigo ang pagsumite ng order, pakisubukan ulit.',
    'KTV': 'KTV',
    'VIP餐厅': 'VIP Dining',
    '合作单位': 'Partner Accounts',
    '选择挂账单位': 'Select Account to Charge',
    '当前欠款': 'Current Balance',
    '确认挂账': 'Confirm Charge',
    '处理中...': 'Processing...',
    '挂账': 'Charge to Account',
    '挂账成功！': 'Charge Successful!',
    '单位': 'Account',
    '金额': 'Amount',
    '挂账订单': 'Charge to Account Order',
    '挂账失败，请重试。': 'Charge to account failed, please try again.',
  },
  ...
  tl: {
    ...
    revenue: 'Kita',
    'VIP包间': 'Mga VIP na Silid',
    '为客房下单，订单将自动流转至后厨': 'Maglagay ng mga order para sa mga kuwarto, awtomatikong papunta sa kusina ang mga order',
    '房间号范围: 8201-8232 (2楼) 和 8301-8332 (3楼)': 'Saklaw ng kuwarto: 8201-8232 (2F) at 8301-8332 (3F)',
    'Kuwarto': 'Kuwarto',
    'Occupied': 'Abala',
    'Vacant': 'Bakante',
    '提交中...': 'Isinusumite...',
